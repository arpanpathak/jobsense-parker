...
- **Microfrontend Architecture**: Refactored a monolithic React.js UI into a microfrontend architecture deployed via **AWS CloudFront CDN**, enabling independent deployability for each publisher team (FreeVee, Twitch, MiniTV). Reduced deployment cycles from **5 days to 30 minutes** and gave each team full autonomy over their feature lifecycle.
